...
enum class LightsparkErrorCode {
    UNKNOWN, NO_CREDENTIALS, MISSING_NODE_KEY, MISSING_WALLET_ID, UNKNOWN_SERVER_ERROR, CONNECTION_FAILED, UNSUPPORTED_CIPHER_VERSION, MISSING_CLIENT_INIT_PARAMETER, WALLET_LOCKED
}