 ...
 * @param shortChannelId The channel's short ID, which is the location in the chain that the channel was confirmed. The format is <block-height>:<tx-index>:<tx-output>.
...
data class Hop(
    ...
    val index: Int,
    @SerialName("hop_short_channel_id")
