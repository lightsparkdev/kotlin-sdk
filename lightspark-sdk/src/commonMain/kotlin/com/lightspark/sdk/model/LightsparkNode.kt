 ...
 * @param localBalance The sum of the channel balances that are available to send on this node.
 * @param purpose The main purpose of this node. It is used byh Lightspark for optimizations on the node's channels.
...
data class LightsparkNode(
    ...
    override suspend fun getAddresses(client: LightsparkClient, first: Int?, types: List<NodeAddressType>?): NodeToAddressesConnection {
...
""",
    ...
    suspend fun getChannels(client: LightsparkClient, first: Int? = null, statuses: List<ChannelStatus>? = null): LightsparkNodeToChannelsConnection {
        return client.executeRawQuery(
            Query(
                queryPayload = """
