 ...
 * @param destinationId The recipient Lightspark node this deposit was sent to.
...
data class Deposit(
    ...
    @SerialName("deposit_destination")
    ...
    companion object {
        @JvmStatic
        fun getDepositQuery(id: String): Query<Deposit> = Query(
            queryPayload = """
