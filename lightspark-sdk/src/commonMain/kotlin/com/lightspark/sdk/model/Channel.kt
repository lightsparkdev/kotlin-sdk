...
data class Channel(
    ...
    suspend fun getUptimePercentage(client: LightsparkClient, afterDate: Instant? = null, beforeDate: Instant? = null): Int? {
...
""",
                ...
                val connection = requireNotNull(it["entity"]?.jsonObject?.get("transactions")) {
