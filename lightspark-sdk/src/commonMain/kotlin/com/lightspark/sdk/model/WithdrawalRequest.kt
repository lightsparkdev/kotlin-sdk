...
data class WithdrawalRequest(
    ...
    suspend fun getChannelClosingTransactions(client: LightsparkClient, first: Int? = null): WithdrawalRequestToChannelClosingTransactionsConnection {
...
""",
                ...
                val connection = requireNotNull(it["entity"]?.jsonObject?.get("channel_closing_transactions")) {
    ...
    suspend fun getChannelOpeningTransactions(client: LightsparkClient, first: Int? = null): WithdrawalRequestToChannelOpeningTransactionsConnection {
        return client.executeRawQuery(
            Query(
                queryPayload = """
...
""",
                ...
                val connection = requireNotNull(it["entity"]?.jsonObject?.get("channel_opening_transactions")) {
