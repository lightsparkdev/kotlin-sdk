...
data class Account(
    ...
    suspend fun getApiTokens(client: LightsparkClient, first: Int? = null): AccountToApiTokensConnection {
        return client.executeRawQuery(
            Query(
                queryPayload = """
...
""",
                ...
                val connection = requireNotNull(it["current_account"]?.jsonObject?.get("api_tokens")) {
                    "api_tokens not found"
                }
    ...
    suspend fun getBlockchainBalance(
...
""",
                ...
                val connection = requireNotNull(it["current_account"]?.jsonObject?.get("channels")) {
                    "channels not found"
                }
...
""",
                ...
                val connection = requireNotNull(it["current_account"]?.jsonObject?.get("transactions")) {
...
""",
                ...
                val connection = requireNotNull(it["current_account"]?.jsonObject?.get("payment_requests")) {
