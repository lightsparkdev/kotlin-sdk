//[lightspark-server-sdk](../../../index.md)/[com.lightspark.sdk.server](../index.md)/[LightsparkCoroutinesClient](index.md)
...
| [createNodeWalletAddress](create-node-wallet-address.md) | [common]<br>suspend fun [createNodeWalletAddress](create-node-wallet-address.md)(nodeId: String): String<br>Creates an L1 Bitcoin wallet address for a given node which can be used to deposit or withdraw funds. |
...
| [deleteApiToken](delete-api-token.md) | [common]<br>suspend fun [deleteApiToken](delete-api-token.md)(tokenId: String): Boolean<br>Delete an API token for the current account. |
...
| [getUnlockedNodeIds](get-unlocked-node-ids.md) | [common]<br>fun [getUnlockedNodeIds](get-unlocked-node-ids.md)(): Flow&lt;Set&lt;String&gt;&gt; |
