//[lightspark-server-sdk](../../../index.md)/[com.lightspark.sdk.server.model](../index.md)/[GraphNode](index.md)/[GraphNode](-graph-node.md)

# GraphNode

[common]\
fun [GraphNode](-graph-node.md)(id: String, createdAt: Instant, updatedAt: Instant, bitcoinNetwork: [BitcoinNetwork](../-bitcoin-network/index.md), displayName: String, alias: String? = null, color: String? = null, conductivity: Int? = null, publicKey: String? = null)
